...
export const ConfirmEndGameModal: FC<ConfirmEndGameModalProps> = ({ isOpen, onClose, onConfirm }) => {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent fullWidth className="space-y-6">
        ...
        <div className="flex gap-4">
          ...
          <button onClick={onConfirm} className="flex-1 bg-red-500 hover:bg-red-600 text-white font-bold py-4 rounded-xl transition-colors text-lg">
            {t('common.confirm')}
          </button>
        </div>
      </DialogContent>
